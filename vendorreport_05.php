...
EOT;
    ...
    while ($row=$mDB->fetchRow(2)) {
		...
		if ($actual_completion_date == "0000-00-00")
...
$casereport_list.=<<<EOT
			<tr>
				...
				<th class="text-center" style="width:5%;padding: 10px;$bgcolor">$actual_entry_date</th>
				<th class="text-center" style="width:5%;padding: 10px;$bgcolor">$actual_completion_date</th>
